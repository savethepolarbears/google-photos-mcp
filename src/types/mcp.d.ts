...
declare module '@modelcontextprotocol/sdk' {
  export class McpServer {
    ...
    registerTool(name: string, options: unknown, handler: (...args: unknown[]) => unknown): void;
    tool(name: string, schema: unknown, handler: (...args: unknown[]) => unknown, options?: unknown): void;
  }
